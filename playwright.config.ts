  ...
  webServer: [
    ...
    },
    {
      ...
      env: {
        ...
        BANK_SECRET_VAULT_URL: 'https://bank-vault.example.test',
        BANK_SECRET_VAULT_MOUNT: 'secret',
        BANK_SECRET_VAULT_TOKEN: 'vault-fixture-token',
        BANK_SECRET_ENCRYPTION_KEY: Buffer.alloc(32, 7).toString('base64'),
